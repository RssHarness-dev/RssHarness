package com.fanexmp.rssgse;

import com.fanexmp.rssgse.ai.conversation.ConversationService;
import com.fanexmp.rssgse.ai.conversation.SearchCallback;
import com.fanexmp.rssgse.ai.rag.RouteCatalog;
import com.fanexmp.rssgse.ai.rag.RouteSyncTask;
...
@Component
@ConditionalOnProperty(name = "rssgse.cli.enabled", havingValue = "true", matchIfMissing = false)
public class CliRunner implements CommandLineRunner {
    ...
    private void printHelp() {
        System.out.println();
        System.out.println("  RSSGSE — RSS-powered Generative Search Engine");
    ...
    private void printBanner() {
        System.out.println();
        System.out.println("  ╔══════════════════════════════════════════════╗");
        System.out.println("  ║     RSSGSE — RSS Generative Search Engine   ║");
